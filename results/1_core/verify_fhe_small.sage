...
# 작은 n(500~1024)만 먼저: 나머지(2048+)는 다음 세션으로 미룸
SMALL_FHE_NAMES = [
    "TFHE16_500", "Concrete_TFHE512", "TFHE20_612", "TFHE630",
    "TFHE16_1024", "TFHE20_1024", "TFHE1024",
    "CHHS_1024_25", "HElib80_1024", "HElib120_1024",
    "SEAL20_1024", "HESv111024128error", "HESv111024128ternary",
]

def main():
    print(f"{'Parameter':<24}{'n':>6}{'def zeta':>10}{'def t':>8}{'def log2rop':>14}{'true zeta':>11}{'true t':>8}{'true log2rop':>14}{'gap':>8}{'time':>8}")
    print("-" * 115)
    for name in SMALL_FHE_NAMES:
        try:
            params = getattr(schemes, name)
        except AttributeError:
            print(f"{name:<24} NOT FOUND in schemes, skipping")
            continue
        try:
            ...
            print(f"{name:<24}{params.n:>6}{default['zeta']:>10}{default.get('t', '-'):>8}{default_log2rop:>14.3f}"
