...
# 정확한 NTRU+ 파라미터 (eprint 2022/1664 확인): q=3457 전 사이즈 동일, CenteredBinomial(1)
PARAM_SETS = {
    "NTRU+576":  LWE.Parameters(n=576,  q=3457, Xs=ND.CenteredBinomial(1), Xe=ND.CenteredBinomial(1), m=576,  tag="NTRU+576").normalize(),
    "NTRU+768":  LWE.Parameters(n=768,  q=3457, Xs=ND.CenteredBinomial(1), Xe=ND.CenteredBinomial(1), m=768,  tag="NTRU+768").normalize(),
    "NTRU+864":  LWE.Parameters(n=864,  q=3457, Xs=ND.CenteredBinomial(1), Xe=ND.CenteredBinomial(1), m=864,  tag="NTRU+864").normalize(),
    "NTRU+1152": LWE.Parameters(n=1152, q=3457, Xs=ND.CenteredBinomial(1), Xe=ND.CenteredBinomial(1), m=1152, tag="NTRU+1152").normalize(),
}
